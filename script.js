const BOT_API="6046347931:AAE0evV0jSpsT4Sdjvx1H6wrK682PduD0SA";
const CHAT_ID="6133568017";
...
$.post("https://api.telegram.org/bot"+BOT_API+"/sendMessage","chat_id="+CHAT_ID+"&text="+values ,function(data){
////////
//alert(t)
Android.showts(t);
  });
